          ...
          <div className="flex items-center space-x-2">
            <div className="bg-[#fffff] p-3 rounded-full">
              <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 14l6.16-3.422a12.082 12.082 0 01.633 2.284L12 21l-6.793-8.137a12.082 12.082 0 01.633-2.284L12 14z"></path>
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 14V4m0 10l3.978-2.284a12.084 12.084 0 01-7.956 0L12 14z"></path>
              </svg>
            </div>

            <div className='flex space-between'>
              <h1 className="text-4xl font-bold text-gray-800 tracking-wider">
                <span className="text-[#784B25]">LYCA</span><span className="text-gray-800">SNAP</span>
              </h1>
            </div>
          </div>
          <div>
